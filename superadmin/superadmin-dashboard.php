...
$total_revenue  = $conn->query("SELECT SUM(total_price) as t FROM bookings WHERE status != 'cancelled'")->fetch_assoc()['t'] ?? 0;
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        .sidebar-logo-text .sub {
            ...
            border-radius: 20px; padding: 1px 8px; display: inline-block; margin-top: 2px;
        }
        ...
        .top-badge {
            background: rgba(168,85,247,0.15); border: 1px solid rgba(168,85,247,0.3);
            color: #c084fc; padding: 8px 16px; border-radius: 10px;
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-value" style="font-size:15px;">NPR <?php echo number_format($total_revenue); ?></div>
            </div>
        </div>
    </div>
                    ...
                    <?php while ($u = $recent_users->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <span class="badge <?php echo $rc; ?>"><?php echo ucfirst(str_replace('_',' ',$u['role'])); ?></span>
                            </td>
                            <td>
